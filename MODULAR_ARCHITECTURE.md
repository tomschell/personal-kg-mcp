...
└── tools/                       # Modular tool groups
    ...
    ├── project.ts               # Project state, session warmup (2 tools)
...
- **Project Tools**: All 2 project tools migrated (Workstream Dashboard removed)
...
- **Workstream Dashboard Removal**: Feature removed as per review requirements
...
- **Total Tools Migrated**: 27 tools across 5 modules (Workstream Dashboard removed)
...
- **Project Tools**: 2 tools (kg_get_project_state, kg_session_warmup)
- **Deprecated Tools**: 6 tools (capture_context, capture_session, query_context, etc.)

### Workstream Dashboard Removal
- **Removed**: kg_workstream_dashboard tool
- **Removed**: Dashboard integration from kg_session_warmup
- **Removed**: Dashboard-related parameters (includeDashboard, dashboardTimeWindow, dashboardFormat, showAttentionAlerts)
- **Removed**: generateAttentionAlerts function and usage
