...
export function setupRelationshipTools(server, storage) {
    ...
    server.tool("kg_create_edge", "Creates explicit relationships between knowledge nodes. Use to link related ideas, mark dependencies, or establish conceptual connections. Relationships are automatically scored for strength based on content similarity.", {
    ...
    server.tool("kg_relationships_maintenance", "Performs relationship maintenance operations including rebuilding weak relationships and pruning outdated connections. Use to keep the knowledge graph clean and relevant.", {
