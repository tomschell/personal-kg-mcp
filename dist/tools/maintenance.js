...
export function setupMaintenanceTools(server, storage) {
    ...
    // =============================================================================
    server.tool("kg_admin", "Unified admin tool for maintenance operations. Supports: 'health' for system status, 'backup' for data protection, 'validate' for integrity checks, 'repair' for fixing issues, 'export'/'import' for data migration, 'rename_tag'/'merge_tags' for tag management.", {
